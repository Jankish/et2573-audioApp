...
public interface BabyDetector {
	 ...
	 * 
	 * @param average is the average for the absolute values measure during the last samples read to the buffer
    ...
    /**
	 * Get a title textlabel for comparing value. (e.g 'Background level' or 'Counter')
	 *
	 * @return a descriptive {@link String}
	 */
